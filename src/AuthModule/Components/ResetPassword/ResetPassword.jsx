  ...
  return (
    <Box sx={{ flexGrow: 1, maxWidth: "95%", margin: "auto" }}>
      <Grid container spacing={2}>
        ...
        <Grid size={6} sx={{ p: 3 }}>
          ...
          >
            ...
            <Box component="form" onSubmit={handleSubmit(onSubmit)}>
              {/* Email */}
              <Typography variant="subtitle2" sx={{ fontWeight: 600, color: "#152C5B", mb: 1 }}>
                Email
              </Typography>
              <TextField
              ...
              />
              <FormHelperText sx={{ color: "red" }}>{errors.confirmPassword?.message}</FormHelperText>
              ...
              />
              <FormHelperText sx={{ color: "red" }}>{errors.seed?.message}</FormHelperText>
        ...
        {/* RIGHT SIDE */}
        <Grid size={6}>
          <Box sx={{ margin: "auto", height: "90vh", position: "relative", p: 2 }}>
            <Box
              sx={{
                width: "100%",
                height: "100%",
            ...
            >
              ...
              />
              <Box sx={{ position: "absolute", bottom: 40, left: 40, color: "#fff", zIndex: 1 }}>
