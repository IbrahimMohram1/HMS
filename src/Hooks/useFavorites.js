...
export default function useFavorites() {
  ...
  const getFavorites = async () => {
    try {
      ...
      // تأكدي من هيكلة البيانات؛ إذا كان هناك أكثر من قائمة مفضلات أو الهيكلة مختلفة
  ...
  const removeFavorite = async (id) => {
    try {
      // إرسال الـ roomId في الـ body حتى مع وجود الـ id في الرابط لحل مشكلة الـ validator
